...
class PGCTags extends StatefulWidget {
  PGCTags({Key key, this.aId, this.sTag, this.title, this.subTitle, this.like, this.cover}):super(key: key);
  final String aId;
  final String sTag;
  final String title;
    ...
    if (widget.sTag == '浅荷话题') {
      return GestureDetector(
        onTap: () async{
          ...
          cookies.add(new Cookie('article', widget.aId));
        ...
        child: Column(
          ...
          children: [
            Container(
              ...
              decoration: BoxDecoration(
                  image: DecorationImage(image: AssetImage(widget.cover), fit: BoxFit.cover),
